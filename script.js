...
function Got_Player_Input(MyEvent) {
  ...
  if (MyEvent.type === 'touchstart' || MyEvent.type === 'mousedown') {
      ...
      const clientX = MyEvent.touches ? MyEvent.touches[0].clientX : MyEvent.clientX;
      const clientY = MyEvent.touches ? MyEvent.touches[0].clientY : MyEvent.clientY;
